...
<nav class="navbar navbar-expand-lg backcol">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="teachersetmarks" style="color:black;">Marks</a>
        </li>
        <li class="nav-item">
...
<div class="section1" id="s1">
    <div class="container-fluid backcol pb-4">
      <div class="container">
        <div class="row">
    <div class="col-md-4"></div>
    <div class="col-md-4 text-center">
    <h3 class="ceo mt-3">-:WELCOME:-</h3>
    </div>
    <div class="col-md-4"></div>
      </div>
      </div>
    ...
    <img class="mt-4" src="images/teacher.png" alt="">
